...
export function CreateWorkspaceDialog({
  ...
  async function onSubmit(values: z.infer<typeof schema>) {
    ...
    try {
      const workspace = await createWorkspaceAction(values.name)
      setOpen(false)
      form.reset()
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger render={trigger ?? <Button>Crea workspace</Button>} />
      <DialogContent>
        <DialogHeader>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Es. Marketing, Prodotto..." {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
