...
// Matches the design system's persistent bottom-right shortcut to the
// workspace's Google Drive — only shown once a workspace has one linked.
export function WorkspaceDriveFab({ driveUrl }: { driveUrl: string | null }) {
